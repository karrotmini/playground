...
export type AppCardFragment = { __typename: 'App', id: string, manifest: { __typename: 'AppManifest', name: string, icon: URL | string }, canonicalHost: { __typename: 'CustomHost', providerInfo: { __typename: 'HostnameProviderInfo', url: URL | string } } };
...
export type ListUserAppsQuery = { __typename: 'Query', userProfile: { __typename: 'UserProfile', apps: Array<{ __typename: 'App', id: string, manifest: { __typename: 'AppManifest', name: string, icon: URL | string }, canonicalHost: { __typename: 'CustomHost', providerInfo: { __typename: 'HostnameProviderInfo', url: URL | string } } }> } | null };

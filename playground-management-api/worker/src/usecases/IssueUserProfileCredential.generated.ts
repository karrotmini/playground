...
export type IssueUserProfileCredentialMutation = { __typename: 'Mutation', issueUserProfileCredential: { __typename: 'IssueUserProfileCredentialResult', credential: string } };
